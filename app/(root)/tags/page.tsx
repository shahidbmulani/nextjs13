    ...
    <>
      ...
      <section className='mt-12 flex flex-wrap gap-4'>
        {result.tags.length > 0 ? (
          result.tags.map((tag) => (
            <Link href={`/tags/${tag._id}`} key={tag._id} className='shadow-light900_darknone'>
          ...
          <NoResult title="No Tags Found" description='There are no tags found' link='/ask-question' linkTitle='Ask a question' />
        )}
      </section>
