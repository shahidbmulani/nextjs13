  ...
  return (
    ...
    <div className='mt-11'>
            ...
            <div className='mb-8 flex flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2'>
              <Link href={`/profile/${answer.author.clerkId}`} className='flex flex-1 items-start gap-1 sm:items-center'>
                ...
                <div className='flex flex-col sm:flex-row sm:items-center'>
                  ...
                  <p className='small-regular text-dark400_light500 mt-0.5 line-clamp-1 ml-0.5'> answerd {" "} {getTimestamp(answer.createdAt)}</p>
                </div>
              </Link>
      ...
      <div className='mt-10 w-full'>
        <Pagination pageNumber={page ? +page : 1} isNext={result.isNextAnswer} />
      </div>
    </div>
