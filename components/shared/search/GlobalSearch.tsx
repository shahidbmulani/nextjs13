    ...
    <div className='relative w-full max-w-[600px] max-lg:hidden' ref={searchContainerRef}>
      <div className='background-light800_darkgradient relative flex min-h-[56px] grow items-center gap-1 rounded-xl px-4'>
        ...
        <Input type='text' value={search} onChange={(e) => {
          ...
          placeholder='Search globally' className='paragraph-regular text-dark400_light700 no-focus placeholder border-none shadow-none outline-none bg-transparent' />
      </div>
      {isOpen && <GlobalResult />}
    </div>
  )
